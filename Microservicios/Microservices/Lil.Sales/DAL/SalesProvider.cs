    ...
    public class SalesProvider : ISalesProvider
    {
        ...
        public SalesProvider()
        {
            ...
            repo.Add(new Order()
            {
                ...
                Items = new List<OrderItem>()
                {
                    new OrderItem() {OrderId = "0002", Id = 1, Price = 50,ProductId = "3", Quantity = 1 },
            ...
            repo.Add(new Order()
            {
                ...
                Items = new List<OrderItem>()
                {
                    new OrderItem() {OrderId = "0003", Id = 1, Price = 50,ProductId = "1", Quantity = 1 },
                    new OrderItem() { OrderId = "0003", Id = 2, Price = 50, ProductId = "2", Quantity = 1 }
                }
            });
